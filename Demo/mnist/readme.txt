...
mnist::Context *m_mnistContext = nullptr;

m_mnistContext = mnist::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

mnist::OnNewFrame(FramesInFlight)
...
mnist::DestroyContext(m_mnistContext);
...
mnist::Context::s_techniqueLocation = L"./"
...
mnist::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

mnist::Context::PerfEventBeginFn
mnist::Context::PerfEventEndFn

=====================================================================================================
10) Optional: Hook up imgui for automatic UI of technique inputs
=====================================================================================================

if (m_mnist && ImGui::CollapsingHeader("mnist"))
    outline::MakeUI(m_mnist);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("mnist", mnist::CreateModule);

in the python module, you will need to "import mnist", and when will be able to set user exposed
variables like:

mnist.Set_<variable name>(<value>);
